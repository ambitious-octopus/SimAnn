...
<experiments>
  ...
  <experiment name="run#3" repetitions="1000" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
    <metric>count workers with [not employed?] / count workers</metric>
    ...
    <metric>ln min [wage-offered-Wb] of firms</metric>
    <metric>ln max [wage-offered-Wb] of firms</metric>
